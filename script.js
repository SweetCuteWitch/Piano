...
function playSound(elem){
    switch(elem.value){
        case "c♯":
            var audio = new Audio('assets/audio/c♯.mp3');
            audio.play();
            break;
        case "d♯":
            var audio = new Audio('assets/audio/d♯.mp3');
            audio.play();
            break;
        case "f♯":
            var audio = new Audio('assets/audio/f♯.mp3');
            audio.play();
            break;
        case "g♯":
            var audio = new Audio('assets/audio/g♯.mp3');
            audio.play();
            break;
        case "a♯":
        ...
        case "d":
            ...
            break;
        case "e":
            var audio = new Audio('assets/audio/e.mp3');
            audio.play();
            break;
        case "f":
            var audio = new Audio('assets/audio/f.mp3');
        ...
        case "a":
            ...
            break;
        case "b":
            var audio = new Audio('assets/audio/b.mp3');
            audio.play();
            break; 
